...
const Index = () => {
  const { data, isOnline, isSyncing, createList, forceSync } = useGrocery();
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="bg-primary text-primary-foreground px-4 py-6 safe-top">
        <div className="flex items-center justify-between mb-2">
          <h1 className="font-display font-bold text-2xl">Grocery Lists</h1>
          <div className="flex items-center gap-2">
            ...
            {isOnline ? (
              ...
              <WifiOff className="w-5 h-5 text-primary-foreground/60" />
            )}
          </div>
        </div>
              ...
              {data.lists.map((list) => {
                ...
                return (
                  <motion.button
                    ...
                    className="w-full bg-card rounded-xl p-4 shadow-soft text-left"
                  >
